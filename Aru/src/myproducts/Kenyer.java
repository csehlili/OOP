...
public class Kenyer extends Aru {
	...
	public String toString() {
		return "Kenyer [" + super.toString() + ", egysegar: " + brutto_ar() / mennyiseg + "]";
	}
	...
	public static boolean elso_kenyer_nagyobb_egysegaru(Kenyer elso_kenyer, Kenyer masodik_kenyer) {
		if (elso_kenyer.brutto_ar() / elso_kenyer.mennyiseg > 
		masodik_kenyer.brutto_ar() / masodik_kenyer.mennyiseg) {
			return true;
		} else return false;
	}
